...
MyKeyboard::MyKeyboard(int x, int y)
{
    ...
    wchar_t code_line1[13][4] = {{L'`', L'~', L'ё', L'Ё'},
                                 {L'1', L'!', L'1', L'!'},
                                 {L'2', L'@', L'2', L'"'},
                                 {L'3', L'#', L'3', L'№'},
                                 {L'4', L'$', L'4', L';'},
                                 ...
                                 {L'-', L'_', L'-', L'_'},
                                 {L'=', L'+', L'=', L'+'}};
    wchar_t code_line2[12][4] = {{L'q', L'Q', L'й', L'Й'},
                                 {L'w', L'W', L'ц', L'Ц'},
                                 {L'e', L'E', L'у', L'У'},
                                 {L'r', L'R', L'к', L'К'},
                                 {L't', L'T', L'е', L'Е'},
                                 ...
                                 {L'[', L'[', L'х', L'Х'},
                                 {L']', L']', L'ъ', L'Ъ'}};
    wchar_t code_line3[11][4] = {{L'a', L'A', L'ф', L'Ф'},
                                 {L's', L'S', L'ы', L'Ы'},
                                 {L'd', L'D', L'в', L'В'},
                                 {L'f', L'F', L'а', L'А'},
                                 {L'g', L'G', L'п', L'П'},
                                 ...
                                 {L';', L':', L'ж', L'Ж'},
                                 {L'"', L'"', L'э', L'Э'}};
    wchar_t code_line4[10][4] = {{L'z', L'Z', L'я', L'Я'},
                                 {L'x', L'X', L'ч', L'Ч'},
                                 {L'c', L'C', L'с', L'С'},
                                 {L'v', L'V', L'м', L'М'},
                                 {L'b', L'B', L'и', L'И'},
    ...
    sf::String names_line1[13]
            = {"`", "1", "2", "3", "4", "5", "6", "7", "8", "9", "0", "-", "="};
    sf::String names_line2[12] = {L"q",
                                  L"w",
                                  L"e",
                                  L"r",
                                  L"t",
                                  ...
                                  L"[",
                                  L"]"};
    sf::String names_line3[11] = {
            L"a", L"s", L"d", L"f", L"g", L"h", L"j", L"k", L"l", L";", L"'"};
    sf::String names_line4[10]
    ...
    //вторая линия
    for (unsigned int i = 13, j = 0; i < 25; i++, j++) {
        //последовательность важна
